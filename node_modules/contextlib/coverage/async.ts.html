...
<head>
    <title>Code coverage report for async.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> async.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {Result as WithResult, Success as WithSuccess} from './with'
&nbsp;
/**
...
&nbsp;
    async exit(error?: unknown): Promise&lt;boolean&gt; {
        ...
        while (this._exitCallbacks.length !== 0) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (cb === undefined) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    popAll(</span>): ExitStack {
        const stack = <span class="cstat-no" title="statement not covered" >new ExitStack();</span>
<span class="cstat-no" title="statement not covered" >        stack._exitCallbacks = this._exitCallbacks;</span>
<span class="cstat-no" title="statement not covered" >        this._exitCallbacks = [];</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat Oct 29 2022 18:38:29 GMT+0100 (West Africa Standard Time)
            </div>
